...
const fSummary = require("../models/financialSummary")

const getAllProductsAvailableFunds = async (req, res) => {
    try {
        const { userID } = req.user;
        const products = await Products.find({})
        const fSummaryDoc = await fSummary.findById(userID);
        const availableFunds = fSummaryDoc.availableFunds;
